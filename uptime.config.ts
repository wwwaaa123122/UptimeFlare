...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      name: '博客',
      method: 'HEAD',
      target: 'https://www.xc-lr.cn/',
      statusPageLink: 'https://www.xc-lr.cn/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '邮箱',
      method: 'HEAD',
      target: 'https://mail.mcxclr.top/',
      statusPageLink: 'https://mail.mcxclr.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'OneDrive分享',
      method: 'HEAD',
      target: 'https://pan.mcxclr.top/',
      statusPageLink: 'https://pan.mcxclr.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '随机图',
      method: 'GET',
      target: 'https://pic.mcxclr.top/',
      statusPageLink: 'https://pic.mcxclr.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },,
    ...
    },
    {
      ...
      name: '德国机 SSH',
      method: 'TCP_PING',
      target: '77.90.2.34:27878',
      timeout: 5000,
    },
    {
      id: 'us_shengdaoyun.cn',
      name: '美国（圣道云）',
      method: 'TCP_PING',
      target: '38.165.42.232:22',
      timeout: 5000,
    }
  ],
  notification: {
    ...
    webhook: {
      ...
      payload: {
        "from": "系统状态更新 <uptimeflare@update.mail.mcxclr.top>",
        "to": ["wwwaaa123122@qq.com"],
